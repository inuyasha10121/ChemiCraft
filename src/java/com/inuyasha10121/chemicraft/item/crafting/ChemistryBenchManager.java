package com.inuyasha10121.chemicraft.item.crafting;
...
public class ChemistryBenchManager
{
    /** The static instance of this class */
    private static final ChemistryBenchManager INSTANCE = new ChemistryBenchManager();
    private final List<IRecipe> recipes = Lists.<IRecipe>newArrayList();

    /**
     * Returns the static instance of this class
     */
    public static ChemistryBenchManager getInstance()
    {
        /** The static instance of this class */
        return INSTANCE;
    }

    private ChemistryBenchManager()
    {
